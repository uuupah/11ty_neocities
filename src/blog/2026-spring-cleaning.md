...
{% youtubetile "https://www.youtube.com/watch?v=Plv_w98ymwk", "the seduction of claude debussy by art of noise", "/_assets/img/blog_2026/artofnoise.webp" %}
...
[link](https://severandpierce.thecomicseries.com/comics/1/)  
...
### golden kamuy
{% blogImage "/_assets/img/blog_2026/goldenkamuy.webp" %}
...
## games
### orbitals
{% youtubetile "https://www.youtube.com/watch?v=bvMDXtgz1bo", "orbitals announcement trailer", "/_assets/img/blog_2026/orbitals.webp" %}
...
<div class="two-columns">
  <div>
    {% blogImage "/_assets/img/blog_2026/luigibike.webp" %}
  </div>
  <div>
    {% blogImage "/_assets/img/blog_2026/luigiplane.webp" %}
  </div>
</div>

i found out about this dude from [the well there's your problem podcast](https://www.wtyppod.com/) because he 1. designed a bunch of honestly really nice looking trucks andc cars and stuff and 2. the guy was a german man pretending to be an italian man. anyway yeah i just think he's neat

## food
### native and ancient pet nat pinot
{% blogImage "/_assets/img/blog_2026/nativeancient.webp", 360 %}
[link](https://www.danmurphys.com.au/product/DM_159686/native-ancient-pet-nat-pinot-x-syrah)
...
### extra
## chop suey by torwai
{% youtubetile "https://www.youtube.com/watch?v=Ru4aqzjvplw", "system of a down - chop suey [cover by torwai]", "/_assets/img/blog_2026/chopsuey.webp" %}
